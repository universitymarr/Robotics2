%% dynamic model of PRR planar robot under gravity
...
%% link 3
pc3 = [q1+L2*cos(q2)+d3*cos(q2+q3); L2*sin(q2)+d3*sin(q2+q3);0];
...
% respect qd1 because this will be the factor that multiplying the square of velocity  of +
% joint 1 we do the same also for joint 2
...
%  M=[a1 -a4*sin(q2+q3)-a5*sin(q2) -a4*sin(q2+q3);
%      -a4*sin(q2+q3)-a5*sin(q2) a2+2*a6*cos(q3) a3+a6*cos(q3);
%      -a4*sin(q2+q3) a3+a6*cos(q3) a3;];
